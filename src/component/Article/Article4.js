  ...
  return (
    <div>
      ...
      <div className={styles.topnews_content}>
        ...
        <div className={styles.topnews_part}>
          에릭 텐하흐 감독 체제로 팀을 재편 중인 맨유는 아약스 감독이었던 텐하흐
          감독이 친숙한 네덜란드 에레디비시 커넥션을 구축하려고 노력 중이다.
          아약스 시절 텐하흐 감독이 지도했던 바르셀로나 미드필더 프렝키 더용
          영입이 임박한 데 이어 네덜란드 왼쪽 풀백 말라시아 영입도 추진하고
          있다.
        </div>
        ...
        <div className={styles.topnews_part}>
          ...
          맨유와 아스널이 동시에 노리는 아르헨티나 수비수 리산드로 마르티네스와
          관련이 있다.
        </div>
        <div className={styles.topnews_part}>
          맨유는 당초 아약스의 율리안 팀버를 노렸으나 최근에는 팀버의 파트너
          마르티네스 영입에 눈을 돌린 것으로 알려졌다. 그런데 말라시아를
          영입했으니 마르티네스는 데려오지 않을 것이라는 관측이 제기된다. 포지션
          중복 문제는 아니다. 마르티네스가 왼쪽 풀백도 소화할 수 있는 선수이긴
          하나 마르티네스는 본업이 센터백이고 수비형 미드필더 역할도 맡을 수
          있다.
        </div>
        <div className={styles.topnews_part}>
        ...
        <div className={styles.topnews_part}>
          ...
          맨유가 말라시아 영입을 마무리한 뒤 본격적으로 마르티네스 영입전에 나설
          것이라고 보도했다. 텐하흐 감독은 아약스 시절 수비진의 키에 크게
