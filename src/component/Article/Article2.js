    ...
    <div>
      ...
      <div className={styles.topnews_content}>
        ...
        <div className={styles.topnews_part}>
          ...
          토너먼트에서 모든 경기에 출전하여 2020-21 잉글랜드 남자 올해의 선수로
          선정되었습니다. 전 감독인 마르셀로 비엘사 밑에서 핵심 선수였던
          필립스는 리즈가 16년 만 에 프리미어리그로 승격 된 2019-20 시즌 동안
          챔피언십에서 37경기를 뛰었습니다 . 그는 지난 시즌 햄스트링 부상으로
          오랜 기간 경기에 출전하지 못했으며 리그 20경기에 출전하는 데 그쳤다.
        </div>
        <div className={styles.topnews_part}>
        ...
        <div className={styles.topnews_part}>
          ...
          감독입니다. 그는 클럽에 생명을 불어넣었고, 선수들과 클럽에 관련된 모든
          사람들에게 우리가 16년 만에 프리미어 리그로 돌아갈 수 있을 만큼 충분히
          훌륭하다는 믿음을 준 사람입니다.
        </div>

        <div className={styles.topnews_part}>
          "당신은 클럽에 모든 것을 주었을 뿐만 아니라 경기장 안팎에서 내가
          오늘날의 사람이 되는 데 필요한 모든 것을 주었습니다." 그는 또한 새로운
          감독 Jesse Marsch를 "믿을 수 없는" 보스이자 "더 나은 사람"이라고
          환영했습니다. 필립스는 팬들이 "자신의 꿈을 쫓기 위해" 떠나는 그의
          결정을 팬들이 이해하길 바란다고 덧붙였다.
        </div>
      </div>
    </div>
  );
